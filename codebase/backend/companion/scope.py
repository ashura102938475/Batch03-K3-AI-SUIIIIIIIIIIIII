...
EXTERNAL_STRONG_SIGNALS = (
    ...
    "tai lieu tham khao", "web search", "search web", "tim kiem tren mang",
) + EXTERNAL_SUPPORT_SIGNALS
...
EXTERNAL_WEAK_SIGNALS = (
    ...
    "doc them", "tim hieu them", "tim them ve", "nguon ngoai slide", "tu nguon ngoai",
    "tra cuu them", "ho tro them",
)
